...
public class SpilInfo {
    ...
    public static void openGameBoard() {
        addStart(1, "Start", "Du vil modtage 2 når du passerer dette felt!", 0, Color.WHITE);
        ...
        addChance(4, "CHANCE", "Du får en chance..", 0, Color.WHITE);
        ...
        addChance(10, "CHANCE", "Du får endnu en chance..",0, Color.GRAY);
        ...
        addParkering(13, "GRATIS PARKERING\n", "Du kan parkere her uden bekymringer..",0, Color.WHITE);
        ...
        addChance(16, "CHANCE", "Du får squ endnu en chance..",0, Color.GRAY);
        ...
        addStraf(19, "GÅ I FÆNGSEL", "Oops, du er havnet i fængslet!",3, Color.GRAY);
        ...
        addChance(22, "CHANCE", "Du får endnu en chance..",0, Color.GRAY);
